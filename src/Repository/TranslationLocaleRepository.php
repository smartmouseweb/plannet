...
/**
 * @extends ServiceEntityRepository<TranslationLocale>
 */
class TranslationLocaleRepository extends ServiceEntityRepository
{
    ...
    //    /**
    //     * @return TranslationLocale[] Returns an array of TranslationLocale objects
    //     */
    ...
    //    public function findOneBySomeField($value): ?TranslationLocale
    //    {
    //        return $this->createQueryBuilder('t')
    //            ->andWhere('t.exampleField = :val')
    //            ->setParameter('val', $value)
